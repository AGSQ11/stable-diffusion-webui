...
{"Alternatively, use a binary release of WebUI: https://github.com/AGSQ11/stable-diffusion-webui/releases" if is_windows else ""}
...
def version_check(commit):
    try:
        import requests
        commits = requests.get('https://api.github.com/repos/AGSQ11/stable-diffusion-webui-directml/branches/master').json()
...
def prepare_environment():
    ...
    sd_repo = os.environ.get('BLIP_REPO', 'https://github.com/AGSQ11/stablediffusion-directml.git')
    k_diffusion_repo = os.environ.get('BLIP_REPO', 'https://github.com/AGSQ11/k-diffusion-directml.git')
    ...
    if (not is_installed("xformers") or args.reinstall_xformers) and args.xformers:
        if platform.system() == "Windows":
            if platform.python_version().startswith("3.10"):
                ...
                print("You can also check this and build manually: https://github.com/AGSQ11/stable-diffusion-webui/wiki/Xformers#building-xformers-on-windows-by-duckness")
